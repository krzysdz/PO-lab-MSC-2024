...
inline ModelARX<T, DT>::ModelARX(std::vector<T> &&coeff_a, std::vector<T> &&coeff_b, const DT delay,
                                 const T stddev)
...
template <std::floating_point T, std::unsigned_integral DT>
void ModelARX<T, DT>::set_coeff_a(std::vector<T> &&coefficients) noexcept
{
...
template <std::floating_point T, std::unsigned_integral DT>
void ModelARX<T, DT>::set_coeff_b(std::vector<T> &&coefficients) noexcept
{
...
template <std::floating_point T, std::unsigned_integral DT>
void ModelARX<T, DT>::set_transport_delay(const DT delay)
{
...
template <std::floating_point T, std::unsigned_integral DT>
inline void ModelARX<T, DT>::set_stddev(const T stddev)
{
...
template <std::floating_point T, std::unsigned_integral DT> T ModelARX<T, DT>::symuluj(T u)
{
